...
[![NuGet version](https://img.shields.io/nuget/v/Rotomeca.Utils)](https://www.nuget.org/packages/Rotomeca.Utils)
[![CI](https://github.com/rotomeca-libs/utils-csharp/actions/workflows/ci.yml/badge.svg)](https://github.com/rotomeca-libs/utils-csharp)
...
[![Docs](https://img.shields.io/badge/docs-github.io-blue)](https://rotomeca-libs.github.io/utils-csharp/index.html)


Bibliothèque C# utilitaire qui fournit un ensemble de fonctions/extensions pures, interfaces et classes utilitaires pouvant couvrir les besoins des différents dévelloppement en C#.
